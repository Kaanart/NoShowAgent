...
- [x] **Task:** Create a second Cloud Function to act as the main backend API for the frontend.
...
- [x] **Task:** Conductor - User Manual Verification 'Phase 2: Backend and API Development' (Protocol in workflow.md)
